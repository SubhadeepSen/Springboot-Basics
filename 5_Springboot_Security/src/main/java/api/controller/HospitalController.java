...
public class HospitalController {
	...
	//Call this method first before performing any operation using the URL: localhost:8080/restapi/test/init
	@RequestMapping(value = "/init", method = RequestMethod.GET)
	public @ResponseBody String initHospitalRepository() throws Exception {
		hospitalService.initHospitalRepository();
